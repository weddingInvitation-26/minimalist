document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
      particlesJS('particles-js', {
        particles: {
          ...
          line_linked: { enable: true, distance: 150, color: '#C9A96E', opacity: 0.05, width: 1 },
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#C9A96E', '#E8D5A3', '#B8A085', '#8B7355', '#FAF8F5'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    ...
    'linear-gradient(135deg, #B8A085, #D4C4B0)',
    'linear-gradient(135deg, #8B7355, #B8A085)',
    'linear-gradient(135deg, #E8D5A3, #FAF8F5)',
    'linear-gradient(135deg, #C9A96E, #8B7355)',
    'linear-gradient(135deg, #D4C4B0, #FAF8F5)'
  ];
